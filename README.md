...
| [Tree Ring Memory](https://github.com/TerminallyLazy/Tree-Ring-Memory) | Codex, Claude Code, Cursor, Copilot, Generic Agent | Lifecycle-aware project memory for explicit recall, evidence-backed lessons, and safe forgetting. | Skill, CLI, templates, adapters, examples | Active | Medium |
