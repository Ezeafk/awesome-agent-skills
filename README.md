...
| [sandbaseai/sandbase-skills](https://github.com/sandbaseai/sandbase-skills) | Codex, Claude Code, Cursor, Gemini CLI | Evidence-led multi-source research with an offline evidence-ledger validator. | 88 skills, research workflow, validator, examples | Active | Medium |
