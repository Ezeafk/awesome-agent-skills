...
| [matdev83/golang-curated-agent-skills](https://github.com/matdev83/golang-curated-agent-skills) | Claude Code, Codex, Cursor, OpenCode | Portable Go workflows for concurrency, context, testing, benchmarks, and idiomatic style. | 44 SKILL.md skills, references, examples | Active | Medium |
