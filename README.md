...
| [agentlas-ai/Agentlas-OS](https://github.com/agentlas-ai/Agentlas-OS) | Claude Code, Codex, Gemini CLI, Cursor, local models | Package and route specialist agents and skills with permission and verification gates. | Runtime, agents, skills, commands, memory, policy checks | Active | Medium |
