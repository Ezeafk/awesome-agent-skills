...
| [JasonColapietro/suede-creator-skills](https://github.com/JasonColapietro/suede-creator-skills) | Claude Code, Codex | Reusable code quality, design, marketing, agent workflow, and mobile shipping capabilities. | Skills, scripts, references, templates | Active | Medium |
