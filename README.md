...
| [Bevel-Software/Hexis](https://github.com/Bevel-Software/Hexis) | Claude, ChatGPT, Cursor, Codex, MCP | Git-backed platform for managing, reviewing, and sharing role-scoped skills, tools, and context with AI agents over MCP. | Skill manager, tool vault, MCP server | Active | Medium |
