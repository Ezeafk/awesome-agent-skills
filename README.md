...
| [Xquik](https://github.com/Xquik-dev/x-twitter-scraper) | Codex, Claude, MCP | X data workflows through REST, OpenAPI, webhooks, SDKs, and MCP. | MCP server, OpenAPI, SDKs, examples | Active | Medium |
