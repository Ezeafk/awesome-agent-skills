...
| [Superior Skills](https://github.com/Superior-Trade/superior-skills) | Codex, Claude Code, OpenClaw, Cursor, Generic Agent | Research, backtest, and deploy crypto and prediction-market strategies with explicit confirmation before live trading. | Agent Skills, strategy templates, backtesting workflows, risk controls | Active | High |
